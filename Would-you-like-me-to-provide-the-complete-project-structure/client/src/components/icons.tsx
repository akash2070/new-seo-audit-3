// Lightweight SVG icons to replace Lucide React and eliminate build timeouts
...
export const FileText = ({ className }: { className?: string }) => (
  <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24">
    <path d="M14,2 L20,8 L20,20 A2,2 0 0,1 18,22 L6,22 A2,2 0 0,1 4,20 L4,4 A2,2 0 0,1 6,2 Z" />
...
export const Paintbrush = ({ className }: { className?: string }) => (
  <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24">
    <path d="M18.37 2.63L14 7l-1.59-1.59a2 2 0 0 0-2.82 0L4 11l9 9 1.59-1.59a2 2 0 0 0 0-2.82L13 14l4.37-4.37a2.12 2.12 0 1 0-3-3Z" />
    <path d="M9 7.51V16" />
    <path d="M15 9.51V16" />
  </svg>
);
...
export const Lightbulb = ({ className }: { className?: string }) => (
  <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24">
    <path d="M9 21h6" />
    <path d="M12 17h.01" />
    <path d="M12 3a6 6 0 0 1 6 6c0 3-2 6-6 6s-6-3-6-6a6 6 0 0 1 6-6z" />
  </svg>
);
